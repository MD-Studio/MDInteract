...
setup(
    ...
    version=0.1,
    description='Biomolecular interaction profiling with MD trajectory support',
    ...
    keywords='MDStudio biomoleculs interactions trajectories',
    platforms=['Any'],
    packages=find_packages(),
    py_modules=[distribution_name],
    test_suite="tests",
    install_requires=['mdtraj', 'pandas', 'scipy'],
